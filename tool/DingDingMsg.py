...
class DingDingMsg:
    ding_ding_msg = '''{
        "msgtype": "text",
        "text": {
        "content": "total: ${total} passed: ${passed} failed: ${failed}  error: ${error}  skipped: ${skipped}  run_time: ${run_time} report url: http://172.18.6.183:8080/jenkins/view/autotest(%E8%87%AA%E5%8A%A8%E5%8C%96%E6%B5%8B%E8%AF%95)/job/auto-test/${build_num}/allure/"
        }}'''
