...
class TestSwapEx_094:
    ...
    params = [
        {
            "case_name": "撮合-卖出开仓-部分成交单人多笔价格相同的订单",
            "volume": 2,
            "priceRatio": 0
        },{
            "case_name": "撮合-卖出开仓-全部成交单人多笔价格相同的订单",
            "volume": 1,
            "priceRatio": 0
        },{
            "case_name": "撮合-卖出开仓-部分成交单人多笔价格不同的订单",
            "volume": 2,
            "priceRatio": 0.01
        },{
            "case_name": "撮合-卖出开仓-全部成交单人多笔价格不同的订单",
            "volume": 1,
            "priceRatio": 0.01
        }
    ]
