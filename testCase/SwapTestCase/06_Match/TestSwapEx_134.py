...
@allure.story('闪电平仓-平空')  # 这里填子功能，没有的话就把本行注释掉
...
class TestSwapEx_134:
    ...
    def test_execute(self, params, contract_code):
        with allure.step('详见官方文档'):
            ...
            time.sleep(1)
            swap_api.swap_order(contract_code=contract_code, price=round(self.currentPrice * 0.99, 2), direction='sell',offset='close')
            orderInfo =swap_api.swap_lightning_close_position(contract_code=contract_code,volume=1,direction='buy',order_price_type=params)
