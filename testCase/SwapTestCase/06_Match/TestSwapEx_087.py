...
class TestSwapEx_087:
    ...
    def setup_class(cls):
        with allure.step('*->挂盘'):
            ...
            user01.swap_order(contract_code=cls.contract_code, price=round(cls.currentPrice, 2), direction='sell',volume=15)
            user01.swap_order(contract_code=cls.contract_code, price=round(cls.currentPrice, 2), direction='buy',volume=10)
            pass
