...
class TestSwapTriggerOpenBuy10_008:
    ...
    params = [
              {
                "caseName": "开多-计划委托-最优5档-不输入合约数量",
                "order_price_type": "optimal_5",
                "direction":"buy",
              },{
                "caseName": "开空-计划委托-最优5档-不输入合约数量",
                "order_price_type": "optimal_5",
                "direction":"sell",
              },{
                "caseName": "开多-计划委托-最优10档-不输入合约数量",
                "order_price_type": "optimal_10",
                "direction":"buy",
              },{
                "caseName": "开空-计划委托-最优10档-不输入合约数量",
                "order_price_type": "optimal_10",
                "direction":"sell",
              },{
                "caseName": "开多-计划委托-最优20档-不输入合约数量",
                "order_price_type": "optimal_20",
                "direction":"buy",
              },{
                "caseName": "开空-计划委托-最优20档-不输入合约数量",
                "order_price_type": "optimal_20",
                "direction":"sell",
              }
            ]
