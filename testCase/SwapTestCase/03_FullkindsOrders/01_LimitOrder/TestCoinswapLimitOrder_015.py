...
@pytest.mark.stable
class TestCoinswapLimitOrder_015:
	...
	def test_execute(self, contract_code):
		...
		with allure.step('1、盘口无卖盘，最优20档买入开多'):
			...
			r = swap_api.swap_order(contract_code=contract_code, volume='20', direction='buy', offset='open',
