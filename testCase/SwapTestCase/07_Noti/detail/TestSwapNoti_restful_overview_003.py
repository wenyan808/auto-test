...
@pytest.mark.stable
class TestSwapNoti_restful_overview_003:

    contract_code = DEFAULT_CONTRACT_CODE
    ids = ['TestSwapNoti_restful_overview_003']
    params = [{'case_name':'restful请求detail接口 传参合约代码','contract_code':contract_code}  ]
    ...
    def test_execute(self, params):
        ...
        with allure.step('验证：返回结果各字段不为空'):
            ...
            for col in checked_col:
                assert result['tick'][col],col+'为空校验失败'
            pass