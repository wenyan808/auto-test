...
@allure.story('restful请求K线30min 选填参数验证：只传to,不传from')  # 这里填子功能，没有的话就把本行注释掉
@pytest.mark.stable
@allure.tag('Script owner : 余辉青', 'Case owner : 吉龙')
class TestSwapNoti_restful_kline_032:
    ...
    @allure.title('restful请求K线30min 只传to,不传from')
    @allure.step('测试执行')
