...
@allure.story('restful请求K线5min 选填参数验证：from传参错误 非时间戳')  # 这里填子功能，没有的话就把本行注释掉
@pytest.mark.stable
@allure.tag('Script owner : 余辉青', 'Case owner : 吉龙')
class TestSwapNoti_restful_kline_015:
    ...
    @allure.title('restful请求K线5min from传参错误 非时间戳')
    @allure.step('测试执行')
