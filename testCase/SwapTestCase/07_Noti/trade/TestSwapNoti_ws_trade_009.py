...
@pytest.mark.stable
class TestSwapNoti_ws_trade_009:
    ids = ['TestSwapNoti_ws_trade_009']
    params = [{'case_name':'合约未上市'}]
    ...
    def test_execute(self, params):
        ...
        contract_info = SwapTool.getContractStatus(instrument_status=4)#使用了待开盘合约
