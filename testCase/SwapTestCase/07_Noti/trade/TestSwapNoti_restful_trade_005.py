...
@pytest.mark.stable
class TestSwapNoti_restful_trade_005:
    ids = ['TestSwapNoti_restful_trade_005']
    params = [{'title': 'TestSwapNoti_restful_trade_005', 'case_name': '获取市场最近成交记录-合约不存在'}]
    ...
    def test_execute(self, params):
        ...
        with allure.step('操作:执行请求'):
            r=user01.swap_trade(contract_code='BTC-U')
            pass
