...
class TestUserInit_swap_003:
    ...
    @pytest.mark.dependency(name='TestUserInit_swap_003')
    def test_execute(self, params):
        ...
        with allure.step('操作：有仓位进行清仓(无则跳过)'):
            if position_info_1 > 0:
                ...
                user03.swap_order(contract_code=self.contract_code, price=self.latest_price, volume=position_info_1,
            ...
            if position_info_2 > 0:
                print(f'当前用户持有空仓数量{position_info_2},开始进行清仓……')
