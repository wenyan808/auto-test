...
@pytest.mark.stable
class TestSwapNoti_api_009:
    ids = ['TestSwapNoti_api_009']
    params = [{'title': 'TestSwapNoti_api_009', 'case_name': 'WS 深度'}]
    ...
    def test_execute(self, params):
        ...
        with allure.step('操作:执行请求'):
            subs = {
                "sub": "market.{}.depth.step0".format(self.contract_code),
                "id": "id5"
            }
            r = user01.swap_sub(subs=subs,keyword='asks')
            pass
