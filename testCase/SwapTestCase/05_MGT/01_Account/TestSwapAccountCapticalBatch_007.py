...
class TestSwapAccountCapticalBatch_007:
    ids = ['TestSwapAccountCapticalBatch_007','TestSwapAccountCapticalBatch_207']
    params = [{'case_name': '平台流水表-每日跑批-平账', 'userType': 13,'type':1},
              {'case_name': '平台流水表-单日0-24流水-平账', 'userType': 13,'type':3}]
