...
class TestSwapAccountCapticalBatch_001:
    ...
    ids = ['TestSwapAccountCapticalBatch_001','TestSwapAccountCapticalBatch_201']
    params = [{'case_name':'平台流水表-每日跑批-平台资产','userType': 11,'type': 1},
              {'case_name':'平台流水表-单日0-24流水-平台资产','userType': 11,'type': 3}]
