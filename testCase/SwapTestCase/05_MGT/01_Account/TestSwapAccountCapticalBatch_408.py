...
class TestSwapAccountCapticalBatch_408:
    ...
    params = [
                {'case_name': '平台流水表-结算对账-【从币币转入】横向对账','colName':'moneyIn'},
                {'case_name': '平台流水表-结算对账-【转出至币币】横向对账','colName':'moneyOut'},
                {'case_name': '平台流水表-结算对账-【借贷转运营】横向对账','colName':'borrowToOperate'},
                {'case_name': '平台流水表-结算对账-【运营转借贷】横向对账','colName':'operateToBorrow'},
                {'case_name': '平台流水表-结算对账-【注入到爆仓】横向对账','colName':'toBurst'},
                {'case_name': '平台流水表-结算对账-【从爆仓提取】横向对账','colName':'fromBurst'},
                {'case_name': '平台流水表-结算对账-【给用户赠币赔偿】横向对账','colName':'compensate'},
                {'case_name': '平台流水表-结算对账-【扣减用户资产惩戒】横向对账','colName':'discipline'},
                {'case_name': '平台流水表-结算对账-【手续费转运营】横向对账','colName':'feeToOperate'},
                {'case_name': '平台流水表-结算对账-【活动奖励】横向对账','colName':'actionReward'},
                {'case_name': '平台流水表-结算对账-【返利】横向对账','colName':'dividend'},
                {'case_name': '平台流水表-结算对账-【开仓手续费挂单】横向对账','colName':'openFeeMaker'},
                {'case_name': '平台流水表-结算对账-【开仓手续费吃单】横向对账','colName':'openFeeTaker'},
                {'case_name': '平台流水表-结算对账-【平仓手续费挂单】横向对账','colName':'closeFeeMaker'},
                {'case_name': '平台流水表-结算对账-【平仓手续费吃单】横向对账','colName':'closeFeeTaker'},
                {'case_name': '平台流水表-结算对账-【交割手续费】横向对账','colName':'deliveFee'},
                {'case_name': '平台流水表-结算对账-【资金费-收入】横向对账','colName':'capitalFeeIn'},
                {'case_name': '平台流水表-结算对账-【资金费-支出】横向对账','colName':'capitalFeeOut'},
                {'case_name': '平台流水表-结算对账-【资金费转运营】横向对账','colName':'capitalFeeToOperate'},
                {'case_name': '平台流水表-结算对账-【运营转资金费】横向对账','colName':'operateToCapitalFee'},
                {'case_name': '平台流水表-结算对账-【平账】横向对账','colName':'flatMoney'},
                {'case_name': '平台流水表-结算对账-【当期流水】横向对账','colName':'currInterest'},
              ]
