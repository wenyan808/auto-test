...
class TestLinearTriggerOpenBuy_006:
    ...
    def test_execute(self):
        ...
        offset = 'open'
        leverRate = 5
        with allure.step('1、行情-最新价更新为50000'):
            linear_api.linear_order(contract_code=contractCode,price='50000',order_price_type='limit',lever_rate=5,direction='buy',offset=offset,
                                    volume=1,)
            time.sleep(0.3)
            linear_api.linear_order(contract_code=contractCode, price='50000',order_price_type='limit', lever_rate=5,direction='sell', offset=offset,
                                    volume=1, )
            # 等待成交刷新最新价
            time.sleep(0.3)
            print("》》》》》》》》》》》》》》1、最新价更新为50000")
