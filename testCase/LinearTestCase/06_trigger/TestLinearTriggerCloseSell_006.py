...
@pytest.mark.stable
class TestLinearTriggerCloseSell_006:
    ...
    def setup(self):
        ...
        print('开仓……')
        linear_api.linear_order(contract_code=contractCode, price='50000', order_price_type='limit',
