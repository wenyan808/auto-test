...
class TestLinearTriggerCloseSell_004:
    ...
    def setup(self,symbol, contract_code, lever_rate, directionB, directionS, offsetC, offsetO):
        print('\n测试标题：触发价高于最新价场景，验证计划委托平多单-委托触发'
              '\n*、先清盘避免盘口数据干扰;'
              '\n*、用户先开仓持仓;'
    ...
    def test_execute(self):
        ...
        with allure.step('6、点击卖出平多按钮，弹框点击确认'):
            ...
            orderResult = linear_order.linear_swap_triggerOrder_insert(contract_code=self.contract_code, trigger_type=self.trigger_type,
