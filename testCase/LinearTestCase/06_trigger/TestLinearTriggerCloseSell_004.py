...
@allure.story('最新价低于触发价-刷新最新价-触发')  # 这里填子功能，没有的话就把本行注释掉
@pytest.mark.stable
class TestLinearTriggerCloseSell_004:
    ...
    def setup(self):
        ...
        print('开仓……')
        linear_api.linear_order(contract_code=contractCode, price='49999', order_price_type='limit',
    ...
    def test_execute(self):
        ...
        with allure.step('6、点击卖出平多按钮，弹框点击确认'):
            orderResult = linear_order.linear_swap_triggerOrder_insert(contract_code=contractCode, trigger_type='ge',
    ...
    def teardown(self):
        print('\n平仓，清理测试数据')
        linear_api.linear_order(contract_code='BTC-USDT', price='55000', order_price_type='limit', lever_rate=5,
