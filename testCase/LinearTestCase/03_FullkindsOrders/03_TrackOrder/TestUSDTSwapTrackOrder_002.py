...
class TestUSDTSwapTrackOrder_002:
    ...
    def test_contract_account_position_info(self, contract_code):
        ...
        r = linear_api.linear_cross_track_cancel(contract_code=contract_code, order_id=orderid)
        pprint(r)
        time.sleep(0.5)
        print('\n步骤五:查询跟踪委托历史委托\n')
        ...
        if (actual_price2 != activationprice) or (actual_contract_code2 != contract_code) or (
                actual_orderid2 != orderid):
