...
class TestUSDTSwapTriggerOrder_007:
    ...
    def test_execute(self, symbol):
        with allure.step('1、登录U本位永续界面'):
            ...
            r_order_plan = self.current_user.linear_trigger_order(contract_code=self.contract_code, trigger_type="ge", trigger_price=trigger_price, order_price=order_price, order_price_type="optimal_5", volume=10, direction="sell", offset="close")
