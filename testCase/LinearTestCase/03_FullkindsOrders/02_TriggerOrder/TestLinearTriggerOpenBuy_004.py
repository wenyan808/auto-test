...
@allure.story('开仓')  # 这里填子功能，没有的话就把本行注释掉
@pytest.mark.stable
@allure.tag('Script owner : 余辉青', 'Case owner : 邱大伟')
class TestLinearTriggerOpenBuy_004:

    ids=['TestLinearTriggerOpenBuy_005',
         'TestLinearTriggerOpenBuy_006',
         'TestLinearTriggerOpenBuy_004',
         'TestLinearTriggerOpenSell_005',
         'TestLinearTriggerOpenSell_006',
         'TestLinearTriggerOpenSell_004']
    params = [{'titleName': '开多-触发价低于最新价', 'direction': 'buy', 'trgRatio': 0.99, 'ordRatio': 0.98},
              {'titleName': '开多-触发价等于最新价', 'direction': 'buy', 'trgRatio': 1.00, 'ordRatio': 0.98},
              {'titleName': '开多-触发价高于最新价', 'direction': 'buy', 'trgRatio': 1.01, 'ordRatio': 0.98},
              {'titleName': '开空-触发价低于最新价', 'direction': 'sell', 'trgRatio': 0.99, 'ordRatio': 0.98},
              {'titleName': '开空-触发价等于最新价', 'direction': 'sell', 'trgRatio': 1.00, 'ordRatio': 0.98},
              {'titleName': '开空-触发价高于最新价', 'direction': 'sell', 'trgRatio': 1.01, 'ordRatio': 0.98}]
