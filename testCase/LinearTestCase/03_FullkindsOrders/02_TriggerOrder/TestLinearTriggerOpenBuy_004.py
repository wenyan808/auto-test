...
class TestLinearTriggerOpenBuy_004:
    ...
    ids=['TestLinearTriggerOpenBuy_005 开多-触发价低于最新价',
         'TestLinearTriggerOpenBuy_006 开多-触发价等于最新价',
         'TestLinearTriggerOpenBuy_004 开多-触发价高于最新价',
         'TestLinearTriggerOpenSell_005 开空-触发价低于最新价',
         'TestLinearTriggerOpenSell_006 开空-触发价等于最新价',
         'TestLinearTriggerOpenSell_004 开空-触发价高于最新价']
