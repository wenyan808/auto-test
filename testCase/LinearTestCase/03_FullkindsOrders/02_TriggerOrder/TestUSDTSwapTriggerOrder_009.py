...
步骤/文本
    1、登录U本位永续界面
    2、在当前持仓tab选择持仓BTC当周/USDT-多单，点击计划委托按钮
    3、选择计划止损按钮
...
class TestUSDTSwapTriggerOrder_009:
    ...
    def test_execute(self, symbol):
        with allure.step('1、登录U本位永续界面'):
            ...
            r_order_plan = self.current_user.linear_trigger_order(contract_code=self.contract_code, trigger_type="le", trigger_price=trigger_price, order_price=order_price, order_price_type="optimal_5", volume=10, direction="sell", offset="close")
