...
@pytest.mark.stable
class TestUSDTSwapLimitOrder_014:
	...
	def test_execute(self, contract_code):
		leverrate = '5'
		with allure.step('1、盘口无买盘，最优10档卖出开空'):
			...
			r = linear_api.linear_cross_order(contract_code=contract_code, volume='20', direction='sell', offset='open',
