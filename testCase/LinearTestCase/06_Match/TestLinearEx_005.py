...
@allure.story('撮合 对手价 买入 开仓')  # 这里填子功能，没有的话就把本行注释掉
@allure.tag('Script owner : Alex Li', 'Case owner : Alex Li')
@pytest.mark.stable
class TestLinearEx_005:
    ...
    @allure.title('撮合 对手价 买入 开仓')
    @allure.step('测试执行')
    def test_execute(self, contract_code):
        with allure.step('1、 撮合 对手价 买入 开仓'):
            pass
        with allure.step('2、点击“确定按钮”'):
            ...
            # 构造对手方,卖10
            repSell = ATP.common_user_make_order(contract_code=contract_code,
