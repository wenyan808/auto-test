...
@allure.story('撮合 卖出平仓 全部成交多人多笔价格相同的订单 ')  # 这里填子功能，没有的话就把本行注释掉
@allure.tag('Script owner : Alex Li', 'Case owner : Alex Li')
@pytest.mark.stable
class TestLinearEx_108:
    ...
    @allure.title('撮合 卖出平仓 全部成交多人多笔价格相同的订单 ')
    @allure.step('测试执行')
    def test_execute(self, contract_code):
        with allure.step('1、撮合 卖出平仓 全部成交多人多笔价格相同的订单'):
            pass
