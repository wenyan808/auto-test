...
步骤/文本
    请求深度(150档不合并),可参考文档：https://docs.huobigroup.com/docs/usdt_swap/v1/cn/#0737c93bf7
预期结果
...
class TestLinearNoti_011:
    ...
    def test_execute(self, contract_code):
        with allure.step('请求深度(150档不合并),可参考文档：https://docs.huobigroup.com/docs/usdt_swap/v1/cn/#0737c93bf7'):
            # asks,bids 数据正确,不存在Null,[]
            res = api.linear_depth(contract_code=contract_code, type='step0')
