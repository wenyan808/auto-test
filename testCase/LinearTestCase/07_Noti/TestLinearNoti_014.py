...
class TestLinearNoti_014:
    ...
    def test_execute(self, contract_code):
        with allure.step(
            ...
            check_keys = ['vol', 'contract_code', 'count', 'open', 'close', 'low', 'high', 'amount', 'trade_partition',
                          'trade_turnover', 'ask', 'bid', 'business_type', 'id', 'ts']
            ...
            act_contract_code = tick.get('contract_code', '')
            assert act_contract_code == contract_code, 'contract_code 错误'
