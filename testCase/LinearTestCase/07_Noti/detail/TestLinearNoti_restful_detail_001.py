...
# @Author : chenwei
    ...
    优先级
        0
    用例别名
        TestLinearNoti_restful_detail_001
"""
...
class TestLinearNoti_restful_detail_001:
    ...
    @allure.title('restful请求聚合行情 传参合约代码')
    @allure.step('测试执行')
    def test_execute(self, contract_code):
        with allure.step('详见官方文档'):
            res = linear_api.linear_detail_merged(contract_code=contract_code)
            pprint(res)
            tradedetail = res['tick']
