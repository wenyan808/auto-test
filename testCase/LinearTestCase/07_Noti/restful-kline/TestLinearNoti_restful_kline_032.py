...
# @Author : 
    ...
    优先级
        2
    用例别名
        TestLinearNoti_restful_kline_032
"""
...
@pytest.mark.stable
class TestLinearNoti_restful_kline_032:
    ...
    def test_execute(self, contract_code):
        with allure.step('详见官方文档'):
            r = linear_api.linear_kline(contract_code=contract_code, period="30min", size=2, to=self.to_time)
            pprint(r)
            klinedata = r['data'][0]
