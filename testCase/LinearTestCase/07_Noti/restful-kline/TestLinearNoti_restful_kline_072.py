...
# @Author : chenwei
    用例标题
        restful请求K线 1week 不传from,to,size
    前置条件
    ...
    优先级
        3
    用例别名
        TestLinearNoti_restful_kline_072
"""
...
@pytest.mark.stable
class TestLinearNoti_restful_kline_072:
    ...
    def test_execute(self, contract_code):
        with allure.step('详见官方文档'):
            r = linear_api.linear_kline(contract_code=contract_code, period="1mon")
            pprint(r)
            errmsg = r['err-msg']
