...
# @Author : chenwei
    ...
    优先级
        1
    用例别名
        TestLinearNoti_restful_kline_048
"""
...
@pytest.mark.stable
class TestLinearNoti_restful_kline_048:
    ...
    def test_execute(self, contract_code):
        with allure.step('详见官方文档'):
            r = linear_api.linear_kline(contract_code=contract_code, period="4hour", size=2,FROM=self.from_time,to=self.to_time)
            pprint(r)
            klinedata = r['data'][0]
