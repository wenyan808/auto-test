...
"""
    用例标题
        母用户- 币本位交割当周-切换杠杆倍数-无持仓有计划单挂单切换杠杆
    前置条件
        母账户切换杠杆不设置功能白名单
...
@pytest.mark.stable
class TestContractLever_s081:

    params = [
        {"contract_type": "this_week", "case_title": "母用户- 币本位交割当周-切换杠杆倍数-无持仓有计划单挂单切换杠杆",
            "id": "TestContractLever_081", "lever_rate": 5},
        {"contract_type": "next_week", "case_title": "母用户- 币本位交割次周-切换杠杆倍数-无持仓有计划单挂单切换杠杆",
            "id": "TestContractLever_082", "lever_rate": 5},
        {"contract_type": "quarter", "case_title": "母用户- 币本位交割当季-切换杠杆倍数-无持仓有计划单挂单切换杠杆",
            "id": "TestContractLever_083", "lever_rate": 5},
        {"contract_type": "next_quarter", "case_title": "母用户- 币本位交割次季-切换杠杆倍数-无持仓有计划单挂单切换杠杆",
         "id": "TestContractLever_084", "lever_rate": 5},

        {"contract_type": "this_week", "case_title": "母用户- 币本位交割当周-切换杠杆倍数-高倍杠杆-无持仓有计划单挂单切换杠杆",
         "id": "TestContractLever_089", "lever_rate": 50},
        {"contract_type": "next_week", "case_title": "母用户- 币本位交割当周-切换杠杆倍数-高倍杠杆-无持仓有计划单挂单切换杠杆",
            "id": "TestContractLever_090", "lever_rate": 50},
        {"contract_type": "quarter", "case_title": "母用户- 币本位交割当周-切换杠杆倍数-高倍杠杆-无持仓有计划单挂单切换杠杆",
            "id": "TestContractLever_091", "lever_rate": 50},
        {"contract_type": "next_quarter", "case_title": "母用户- 币本位交割当周-切换杠杆倍数-高倍杠杆-无持仓有计划单挂单切换杠杆",
         "id": "TestContractLever_092", "lever_rate": 50},
    ]
