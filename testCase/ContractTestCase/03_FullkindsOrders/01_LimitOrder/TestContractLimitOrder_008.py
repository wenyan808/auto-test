...
class TestContractLimitOrder_008:
    ...
    def test_contract_limit_order(self, symbol, symbol_period):
        ...
        r_order_sell = contranct_api.contract_order(symbol=symbol, contract_type='this_week', price=highest_price_buy, volume=str(volume_bid),
