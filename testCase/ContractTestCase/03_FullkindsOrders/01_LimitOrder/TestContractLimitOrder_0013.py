...
@allure.epic('反向交割')
@allure.feature('')
class TestContractLimitOrder_0013:
    ...
    def test_contract_limit_order(self, symbol, symbol_period):
        ...
        pprint("\n步骤四: 以最优10档买入开多\n")
        r_buy_opponent = contract_api.contract_order(symbol=symbol, contract_type='this_week', order_price_type='optimal_10', price="", direction="buy", offset="open", lever_rate=lever_rate, volume=1)
