...
@allure.feature('功能')
@pytest.mark.stable
class TestContractTriggerOrder_007:
    ...
    def test_contract_account_position_info(self, symbol, symbol_period):
        ...
        self.symbol = symbol
        pprint("\n步骤一：查看自己的持仓\n")
        contract_ltc_info = contract_api.contract_contract_info(
        ...
        positions_data = contract_api.contract_account_position_info(
            symbol=symbol).get("data")
