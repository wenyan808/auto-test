...
class TestContractEx_372:
    ids = ['TestContractEx_372',
           'TestContractEx_376',
           'TestContractEx_388',
           'TestContractEx_392',
           'TestContractEx_506',
    ...
    datas = [('quarter', '卖出平仓 部分成交多人多笔价格相同的订单', 0, 1),
             ('quarter', '卖出平仓 全部成交多人多笔价格相同的订单', 0, 2),
             ('quarter', '卖出平仓 部分成交多人多笔价格不同的订单', 0.01, 1),
             ('quarter', '卖出平仓 全部成交多人多笔价格不同的订单', 0.01, 2),
             ('next_quarter', '卖出平仓 部分成交多人多笔价格相同的订单', 0, 1),
             ('next_quarter', '卖出平仓 全部成交多人多笔价格相同的订单', 0, 2),
             ('next_quarter', '卖出平仓 部分成交多人多笔价格不同的订单', 0.01, 1),
             ('next_quarter', '卖出平仓 全部成交多人多笔价格不同的订单', 0.01, 2)]
