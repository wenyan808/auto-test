...
class TestContractEx_253:
    ...
    @allure.title('撮合次周 买入平仓 部分成交多人多笔价格不同的订单')
    @allure.step('测试执行')
    def test_execute(self, symbol, symbol_period, DB_orderSeq):
        with allure.step('详见官方文档'):
            ...
            res2 = user01.contract_order(
                symbol=symbol, contract_type=contract_type, price=self.current*0.98, volume=2, direction="sell", offset="close", order_price_type='limit', lever_rate=5)
            print(res2)
