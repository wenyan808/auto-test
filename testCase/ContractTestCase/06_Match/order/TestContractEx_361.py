...
class TestContractEx_361:

    ids = ['TestContractEx_361',
           'TestContractEx_365',
           'TestContractEx_377',
           'TestContractEx_381',
           'TestContractEx_495',
    ...
    datas = [('quarter', '买入开仓 部分成交单人多笔价格相同的订单',0, 1),
             ('quarter', '买入开仓 全部成交单人多笔价格相同的订单',0, 2),
             ('quarter', '买入开仓 部分成交单人多笔价格不同的订单',0.01, 1),
             ('quarter', '买入开仓 全部成交单人多笔价格不同的订单',0.01, 2),
             ('next_quarter', '买入开仓 部分成交单人多笔价格相同的订单',0, 1),
             ('next_quarter', '买入开仓 全部成交单人多笔价格相同的订单',0, 2),
             ('next_quarter', '买入开仓 部分成交单人多笔价格不同的订单',0.01, 1),
             ('next_quarter', '买入开仓 全部成交单人多笔价格不同的订单',0.01, 2)]
