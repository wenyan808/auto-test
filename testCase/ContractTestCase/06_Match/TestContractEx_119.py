...
class TestContractEx_119:
    ...
    def test_execute(self, symbol):
        with allure.step('步骤详见官方文档'):
            ...
            contract_api.contract_order(symbol=symbol, price=current, volume='5', contract_type=contract_type,
                                        direction="sell", offset=offset, order_price_type=order_price_type)

            res = contract_api.contract_order(symbol=symbol, price=current*1.01, volume='11', contract_type=contract_type,
