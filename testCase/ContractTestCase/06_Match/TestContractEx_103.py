...
class TestContractEx_103:
    ...
    @allure.title('撮合当周 买入平仓 部分成交多人多笔价格相同的订单     ')
    @allure.step('测试执行')
    def test_execute(self, symbol, symbol_period):
        with allure.step('详见官方文档'):
            ...
            pprint(buy_order1)
            buy_order2 = ATP.common_user_make_order(contract_code=symbol_period, price=current,volume=1, direction='buy', offset='close')
