...
# @Author : 
    ...
    用例别名
         用例别名
        TestContractEx_346 撮合当季
        TestContractEx_480 撮合次季
"""
...
class TestContractEx_346:
    ids = ['TestContractEx_346', 'TestContractEx_480']
    datas = [('当季 卖出开仓全部成交 撤单', 'quarter'), ('次季 卖出开仓全部成交 撤单', 'next_quarter')]
