...
# @Author : 
    ...
    优先级
        0
    用例别名
        TestContractEx_347 撮合当季
        TestContractEx_481 撮合次季
"""
...
class TestContractEx_347:
    ids = ['TestContractEx_347', 'TestContractEx_481']
    datas = [('当季 买入平仓全部成交 撤单', 'quarter'), ('次季 买入平仓全部成交 撤单', 'next_quarter')]
