...
# @Author : 
    ...
    优先级
        0
    用例别名
        TestContractEx_344 撮合当季
        TestContractEx_478 撮合次季
"""
...
class TestContractEx_344:
    ids = ['TestContractEx_344', 'TestContractEx_478']
    datas = [('当季 卖出平仓部分成交 撤单', 'quarter'), ('次季 卖出平仓部分成交 撤单', 'next_quarter')]
