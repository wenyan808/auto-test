...
class TestContractEx_354:
    ids = ['TestContractEx_354',
           'TestContractEx_358',
           'TestContractEx_488',
           'TestContractEx_492']

    datas = [('quarter','当季 部分成交 卖出开仓',1),
             ('quarter', '当季 全部成交 卖出开仓',2),
             ('next_quarter', '次季 部分成交 卖出开仓',1),
             ('next_quarter', '次季 全部成交 卖出开仓',2)]
