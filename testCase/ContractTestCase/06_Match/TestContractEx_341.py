...
# @Author : 
    ...
    优先级
        0
    用例别名
        TestContractEx_341 撮合当季
        TestContractEx_475 撮合次季
"""
...
class TestContractEx_341:
    ids = ['TestContractEx_341', 'TestContractEx_475']
    datas = [('当季 买入开仓部分成交 撤单', 'quarter'), ('次季 买入开仓部分成交 撤单', 'next_quarter')]
