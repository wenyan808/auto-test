...
class TestContractLimitOrder_005:
    ...
    def test_contract_limit_order(self, symbol, symbol_period):
        ...
        r_order_buy = contranct_api.contract_order(symbol=symbol, contract_type='this_week', price=lower_price, volume='1',
        ...
        for order in all_orders:
            ...
            if current_order_id == generated_order_id:
                expected_info_dic = {"status": 7, "lever_rate": 5, "order_type": 1, "volume": 1, "price": lower_price}
