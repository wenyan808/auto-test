...
# @Author : chenwei
    用例标题
        restful请求K线 60min 传参from,to,size
    前置条件
    ...
    优先级
        1
    用例别名
        TestContractNoti_restful_kline_039
"""
...
class TestContractNoti_restful_kline_039:
    ...
    @allure.title('restful请求K线 60min 传参from,to,size')
    @allure.step('测试执行')
