...
# @Author : chenwei
    ...
    优先级
        3
    用例别名
        TestContractNoti_restful_kline_078
"""
...
class TestContractNoti_restful_kline_078:
    ...
    def test_execute(self, symbol, symbol_period):
        with allure.step('详见官方文档'):
            period = "1mon"
            result = contract_api.contract_kline(symbol=symbol_period, period=period, size="2", From="abcde")
            pprint(result)
