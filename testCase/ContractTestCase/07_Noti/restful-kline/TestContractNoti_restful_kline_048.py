...
# @Author : chenwei
    用例标题
        restful请求K线 4hour 传参from,to,size
    前置条件
    ...
    优先级
        1
    用例别名
        TestContractNoti_restful_kline_048
"""
...
@pytest.mark.stable
class TestContractNoti_restful_kline_048:
    from_time = None
    to_time = None
    current_price = None
    ...
    @allure.title('restful请求K线 4hour 传参from,to,size')
    @allure.step('测试执行')
