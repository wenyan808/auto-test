...
# @Author : chenwei
    ...
    优先级
        3
    用例别名
        TestContractNoti_restful_kline_079
"""
...
@pytest.mark.stable
class TestContractNoti_restful_kline_079:
    ...
    @allure.title('restful请求K线 1mon to传参错误 非时间戳')
    @allure.step('测试执行')
    def test_execute(self, symbol, symbol_period):
        with allure.step('详见官方文档'):
            period = "1mon"
            result = contract_api.contract_kline(symbol=symbol_period, period=period, size="2", to="abcde")
            pprint(result)
