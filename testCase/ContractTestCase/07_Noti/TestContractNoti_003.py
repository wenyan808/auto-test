...
# @Author : 
    ...
    步骤/文本
        WS订阅深度(20档不合并，即传参step6)，可参考文档：https://docs.huobigroup.com/docs/dm/v1/cn/#websocket-3
    预期结果
        asks,bids 数据正确,不存在Null,[]
    优先级
        0
    用例别名
        TestContractNoti_003
"""
...
@allure.story('20档不合并深度')  # 这里填子功能，没有的话就把本行注释掉
@pytest.mark.stable
class TestContractNoti_003:
    ...
    def test_execute(self, symbol, symbol_period):
        with allure.step('WS订阅深度(20档不合并，即传参step6)，可参考文档：https://docs.huobigroup.com/docs/dm/v1/cn/#websocket-3'):
            contractCode = 'BTC_CW'
            depthType = 'step6'
            result = contract_service_ws.contract_sub_depth(contract_code=contractCode, type=depthType)
