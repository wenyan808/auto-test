...
@pytest.mark.stable
class TestContractNoti_ws_kline_064:
    ...
    def test_execute(self, symbol, symbol_period):
        with allure.step('详见官方文档'):
            period = "1min"
            result = contract_service_ws.contract_sub_kline(contract_code=symbol_period.lower(), period=period)
            pprint(result)
