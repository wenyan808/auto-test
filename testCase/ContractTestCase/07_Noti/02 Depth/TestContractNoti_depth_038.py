...
class TestContractNoti_depth_038:
    ...
    @allure.title('WS订阅深度 不传合约代码')
    @allure.step('测试执行')
    def test_execute(self, symbol, symbol_period):
        with allure.step('参考官方文档'):
            depth_type = 'step6'
            result = contract_service_ws.contract_sub_depth(contract_code='', type=depth_type)
