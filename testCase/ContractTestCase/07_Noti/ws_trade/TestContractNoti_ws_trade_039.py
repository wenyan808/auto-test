...
class TestContractNoti_ws_trade_039:
    ...
    def setup(self, symbol):
        ...
        ATP.common_user_make_order(price=sell_price, order_price_type='limit', direction='sell')
        ATP.common_user_make_order(price=buy_price, order_price_type='limit', direction='buy')
        time.sleep(2)
        self.current_price = ATP.get_current_price()

    @allure.title('WS订阅成交(req)  限价委托成交')
    @allure.step('测试执行')
