...
class TestContractNoti_ws_trade_009:
    ...
    @allure.title('WS订阅成交(sub)  合约未上市')
    @allure.step('测试执行')
    def test_execute(self, symbol, symbol_period):
        with allure.step('详见官方文档'):
            result = contract_service_ws.contract_sub_tradedetail(symbol_period+"H")
            pprint(result)
