...
class TestContractNoti_ws_trade_019:
    ...
    def setup(self, symbol):
        ...
        ATP.common_user_make_order(price=sell_price, order_price_type='optimal_5', direction='sell')
        time.sleep(2)
        ATP.common_user_make_order(price=buy_price,order_price_type='optimal_5', direction='buy')
        time.sleep(1)

    @allure.title('WS订阅成交(sub)  最优5档成交')
    @allure.step('测试执行')
