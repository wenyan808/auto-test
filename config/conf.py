...
ATP_SERVER_ACCESS_KEY = GLOBAL_DATA['ATP_SERVER_ACCESS_KEY']
ATP_SERVER_SECRET_KEY = GLOBAL_DATA['ATP_SERVER_SECRET_KEY']
...
CONTRACT_ORDER = GLOBAL_DATA['CONTRACT_ORDER']
...
def set_run_env_and_system_type(run_env, system_type):
    global ENV, SYSTEM_TYPE, GLOBAL_DATA, URL, URL2, ACCESS_KEY, SECRET_KEY, hbsession, MULANURL, COMMON_SECRET_KEY, COMMON_ACCESS_KEY, ATP_SERVER_ACCESS_KEY, ATP_SERVER_SECRET_KEY, \
        ...
        CANCEL_ALL_TRIGGER_ORDER_URL, POSITION_INFO_URL, CONTRACT_ORDER, CONTRACT_INFO_URL, MARKET_DEPTH_URL, WSURL, REDIS_CONF, MYSQL_CONF, USERINFO, MGT_INFO, MQ_INFO
