...
ENV = 'Test6'
SYSTEM_TYPE = 'Swap'  # Delivery, Swap,  LinearSwap
...
def set_run_env_and_system_type(run_env, system_type):
    global ENV, SYSTEM_TYPE, GLOBAL_DATA, URL, URL2, ACCESS_KEY, SECRET_KEY, hbsession, MULANURL, COMMON_SECRET_KEY, COMMON_ACCESS_KEY, \
        ...
        CANCEL_ALL_TRIGGER_ORDER_URL, POSITION_INFO_URL, PLACE_ORDER_URL, CONTRACT_INFO_URL, MARKET_DEPTH_URL, WSURL,REDIS_CONF, \
        MYSQL_CONF,USERINFO,MQ_INFO,MGT_INFO
