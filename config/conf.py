...
# ACCESS_KEY = "rbr45t6yr4-0cc74c95-2bbac9a6-41272"
# SECRET_KEY = "88da5eca-a320ddff-2ab14481-bc0ac"
...
def set_run_env_and_system_type(run_env, system_type):
    global ENV, SYSTEM_TYPE, GLOBAL_DATA, URL, URL2, ACCESS_KEY, SECRET_KEY, hbsession, MULANURL, COMMON_SECRET_KEY, COMMON_ACCESS_KEY, \
        ...
        CANCEL_ALL_TRIGGER_ORDER_URL, POSITION_INFO_URL, PLACE_ORDER_URL, CONTRACT_INFO_URL, MARKET_DEPTH_URL, WSURL,REDIS_CONF, MYSQL_CONF,USERINFO
